  ...
  return (
    <section id="cultos" className="py-20 px-6 bg-gray-50">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {cultosOrdenados.map((culto, index) => (
            <div
              key={culto.id}
              className={`relative flex flex-col items-center text-center gap-3 p-8 rounded-xl border bg-white transition-all duration-500

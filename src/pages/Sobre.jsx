        ...
        <div className="bg-blue-900 text-white py-20 px-6 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-blue-200 text-lg">
              Conheça a história e a missão da Igreja ADCM Poá
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-16 flex flex-col gap-16">
          ...
          {numeros.length > 0 && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {numeros.map((n) => (
                ...
                >
                  <strong className="block text-3xl font-bold text-blue-900">
                    {n.valor}
                  </strong>
          ...
          {versiculo && (
            <div className="relative bg-blue-900 text-white rounded-2xl p-10 text-center">
              <span className="absolute -top-5 left-8 text-8xl text-white/10 font-serif">
                "
              </span>
              ...
              {referenciaVersiculo && (
                <span className="block mt-4 text-sm font-bold text-blue-200">
                  {referenciaVersiculo}
                </span>
              )}
            </div>
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
                {pastores.map((pastor, i) => (
                  <div
                    key={i}
                    className="flex flex-col items-center text-center p-6 rounded-xl border border-gray-200 hover:shadow-md transition"
                  >
                    {pastor.fotoUrl ? (
                      <OptimizedImage
                        src={pastor.fotoUrl}
                      ...
                      <div className="w-24 h-24 rounded-full bg-gray-100 flex items-center justify-center text-4xl mb-4">
                        👤
                      </div>
                    )}
